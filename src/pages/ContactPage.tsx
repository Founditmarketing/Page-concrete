...
import { Phone, Mail, MapPin, Clock, UploadCloud } from 'lucide-react';
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#1d4e89] focus:border-transparent transition-all" required />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <input type="tel" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#1d4e89] focus:border-transparent transition-all" required />
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-700">Email Address (Optional)</label>
                  <input type="email" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#1d4e89] focus:border-transparent transition-all" />
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-700">Service Needed</label>
                  <select className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#1d4e89] focus:border-transparent transition-all appearance-none cursor-pointer text-slate-700">
                    ...
                    <option value="stamped">Stamped / Decorative Concrete</option>
                ...
                <div className="space-y-2">
                  ...
                  <textarea rows={4} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#1d4e89] focus:border-transparent transition-all resize-none" required></textarea>
                </div>

                <button type="submit" className="w-full bg-[#1d4e89] text-white font-bold text-lg py-4 rounded-xl hover:bg-[#15396b] transition-all shadow-xl #1d4e89/20 active:scale-[0.98] cursor-pointer">
                  Submit Request
                </button>
              </form>
            </motion.div>
